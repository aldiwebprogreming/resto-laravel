...
@extends('layout.main', ['title' => "Data Makanan", "label" => "Data makanan"])
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="post" action="{{ url('admin/act_makanan') }}" enctype="multipart/form-data">
                  ...
                  <table class="table table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><img src="{{ Storage:: url('public/img_makanan/'). $item->gambar }}" alt="" style="height: 100px;"></td>
                          <td>
                          ...
                          <div class="modal fade" id="exampleModalhapus{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                  <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                                    <form method="post" action="{{ url('admin/hapus_food') }}">
                                      @method('delete')
                                        @csrf
                           ...
                           <div class="modal fade" id="exampleModaledit{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="post" action="{{ url('admin/act_edit_food/') }}/{{ $item->id }}" enctype="multipart/form-data">
                                      @method('put')
                                      @csrf
